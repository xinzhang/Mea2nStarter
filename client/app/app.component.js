System.register(['angular2/core', 'angular2/router', 'angular2/http', 'rxjs/Rx', './home/welcome.component', './home/newRelease.component', './home/myGames.component', './auth/register.component', './auth/login.component', './auth/forgotPassword.component', './attributes/highlight.directive', './services/auth.service', './services/game.service', './validators/usernameValidator'], function(exports_1, context_1) {
    ...
    var core_1, router_1, http_1, welcome_component_1, newRelease_component_1, myGames_component_1, register_component_1, login_component_1, forgotPassword_component_1, highlight_directive_1, auth_service_1, game_service_1, usernameValidator_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
            ...
            AppComponent = (function () {
                ...
                AppComponent = __decorate([
                    core_1.Component({
                        ...
                        providers: [router_1.ROUTER_PROVIDERS, http_1.HTTP_PROVIDERS, auth_service_1.AuthService, game_service_1.GameService, usernameValidator_1.UsernameValidator]
                    }),
